-- =====================================================
-- Daily Faith App - Mood System Setup for Supabase
-- =====================================================
-- This script sets up the complete mood tracking system
-- Run this in your Supabase SQL editor

-- 1. Create mood_categories table
...
-- 4. Create mood_influences table
...
-- 14. Create a view for mood entries with details
...
-- 15. Create function to get all active moods
...
-- 17. Create RLS policies for mood_entries
...
-- 18. Create RLS policies for mood_influences
...
-- 20. Create trigger to update updated_at timestamp
