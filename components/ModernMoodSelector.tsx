...
const modernMoodCategories = [
  {
    ...
    moods: [
      ...
      { id: 'spiritual_connected', label: '🌟 Connected', gradient: Colors.gradients.royal },
    ]
  },
  {
    id: 'positive',
    ...
    moods: [
      { id: 'positive_joy', label: '😄 Joyful', gradient: Colors.gradients.warm },
      { id: 'positive_excited', label: '🤩 Excited', gradient: Colors.gradients.fire },
      { id: 'positive_loved', label: '💕 Loved', gradient: Colors.gradients.sunset },
    ]
  },
  {
    id: 'calm',
    ...
    moods: [
      { id: 'calm_relaxed', label: '😌 Relaxed', gradient: Colors.gradients.ocean },
      { id: 'calm_content', label: '😊 Content', gradient: Colors.gradients.softGlow },
      { id: 'calm_balanced', label: '⚖️ Balanced', gradient: Colors.gradients.divineMorning },
    ]
  },
  {
    id: 'challenging',
...
export default function ModernMoodSelector({ onMoodSelect, selectedMood, compact = false }: ModernMoodSelectorProps) {
  ...
  const MoodBubble = ({ mood, isSelected }: { mood: any; isSelected: boolean }) => (
    ...
    >
      ...
      >
        <LinearGradient
          colors={mood.gradient || Colors.gradients.primary}
